#!/usr/bin/env python3
"""
plotter_twoaxis.py - plot raw per-IMU angles from a twoaxis_raw CSV log

    python3 plotter_twoaxis.py logs/twoaxis_raw000.csv
    python3 plotter_twoaxis.py logs/twoaxis_raw0*.csv --overlay
    python3 plotter_twoaxis.py logs/twoaxis_raw000.csv --y imu0_roll_deg,imu1_roll_deg
    python3 plotter_twoaxis.py logs/twoaxis_raw000.csv --unwrap
"""
