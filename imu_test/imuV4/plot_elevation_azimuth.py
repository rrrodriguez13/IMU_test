#!/usr/bin/env python3
"""
plot_elevation_azimuth.py - plot elevation and azimuth from a twoaxis_raw CSV log

    python3 plot_elevation_azimuth.py logs/twoaxis_raw000.csv
    python3 plot_elevation_azimuth.py logs/twoaxis_raw000.csv --m0 0 0 0 --m1 0 90 0
    python3 plot_elevation_azimuth.py logs/twoaxis_raw000.csv --unwrap
"""
