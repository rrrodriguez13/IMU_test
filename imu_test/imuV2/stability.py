...
angle_cols = ['imu0_roll_deg', 'imu0_pitch_deg', 'imu0_yaw_deg']
accel_cols  = ['imu0_ax', 'imu0_ay', 'imu0_az']
all_cols = angle_cols + accel_cols

fig, axes = plt.subplots(len(all_cols), 1, sharex=True, figsize=(12, 16))
fig.suptitle('IMU Stability over Time')
